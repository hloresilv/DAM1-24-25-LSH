...
import static ud5.inmobiliaria.Inmueble.sortPrecioAlquilerAsc;
...
public class Inmobiliaria {
    ...
    public static void main(String[] args) {
        ...
        Arrays.sort(inmuebles, new Comparator<Inmueble>() {
            @Override
        ...
        System.out.println("Ordenados por precio alquiler ascendente");
